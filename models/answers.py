...
class QuestionAnswer(models.Model):
    ...
    selected_option_ids = fields.One2many('easy_exams.answer_option', 'answer_ids',  string="Selected Options")
    answer_text = fields.Text(string="Answer Text")
    is_correct = fields.Boolean(string="Is Correct")
    answer_pair_ids = fields.One2many('easy_exams.question_answer_pair', 'answer_ids', string="Answer Pairs")
